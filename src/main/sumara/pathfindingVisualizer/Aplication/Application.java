...
import sumara.pathfindingVisualizer.Algoritms.AlgorithmBFS;
import sumara.pathfindingVisualizer.Algoritms.AlgorithmDFS;
import sumara.pathfindingVisualizer.Algoritms.AlgorithmGreedy;
import sumara.pathfindingVisualizer.Algoritms.IPathFindingAlgorithm;
...
public class Application {
    ...
    public void generateRandomWalls() {
        if ((pathFindingAlgorithm == null) || (!pathFindingAlgorithm.isRunning())) {
            this.clearWalls();
